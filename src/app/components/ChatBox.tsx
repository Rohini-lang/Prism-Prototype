  ...
  return (
    <div className={`${hasMessages ? "mt-8" : "mt-0"}`}>
          ...
          >
            {SUGGESTED_QUERIES.map((q) => (
              <button
                ...
                className="px-3 py-2 text-xs rounded-full border border-[#E8E4F0] bg-white text-[#7B7694] hover:border-[#9B51E0] hover:text-[#9B51E0] hover:shadow-sm transition-all"
              >
                {q}
              </button>
            ))}
      ...
      <div className="relative">
        <div className="flex items-center gap-3 bg-white border border-[#E8E4F0] rounded-2xl px-5 py-3 shadow-sm focus-within:border-[#9B51E0] focus-within:shadow-md focus-within:shadow-[#9B51E0]/10 transition-all">
          ...
          <input
            ...
            className="flex-1 bg-transparent text-sm text-[#1E1B3A] placeholder:text-[#B5B0C8] focus:outline-none"
          />
          <button
            type="button"
